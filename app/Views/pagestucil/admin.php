...
<div class="judul">
	<h1>Ini Halaman Admin nyaa btw...</h1>
	<p>Kudunya bisa ngedit di sini, namanya juga admin...</p>
</div>
<div class="wrap">
	<div class="card" style="width: 18rem;">
 		<img src="/img/slipon.jpg" class="card-img-top" alt="Sendal Slip On">
  		<div class="card-body">
    		...
    		<a href="/tucil/sendalslipon" class="btn btn-primary">Edit</a>
  		</div>
	</div>
	<div class="card" style="width: 18rem;">
 		<img src="/img/jepit.jpg" class="card-img-top" alt="Sendal Jepit">
  		<div class="card-body">
    		...
    		<a href="/tucil/sendaljepit" class="btn btn-primary">Edit</a>
  		</div>
	</div>
	<div class="card" style="width: 18rem;">
 		<img src="/img/gunung.jpg" class="card-img-top" alt="Sendal Gunung">
  		<div class="card-body">
    		...
    		<a href="/tucil/sendalgunung" class="btn btn-primary">Edit</a>
  		</div>
	</div>
</div>
<?= $this->endSection(); ?>